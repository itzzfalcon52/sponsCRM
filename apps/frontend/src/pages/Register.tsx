...
export default function Register() {
      ...
      { name, email, password },
      {
        onSuccess: () => {
          toast.success("Account created successfully!", {
            description: "Redirecting you to the your organization...",
          });
  ...
  // If already logged in, show this full-screen message instead of the form
  if (isAuthenticated) {
    return (
        ...
        <div className="mx-auto flex max-w-md flex-col items-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              You have an active session. There's no need to create a new account.
            </p>
          </div>
          <Button 
          ...
          >
            Go to Your Organization <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
        </div>
      </div>
    );
  ...
  // Otherwise show the normal register page
  return (
      ...
      <div className="relative hidden flex-col items-center justify-between bg-zinc-900 p-10 text-white lg:flex dark">
        ...
        <div className="z-10 max-w-md">
          ...
          <p className="mt-4 text-lg text-zinc-300">
            Our CRM is built to help you manage sponsorships and close deals
            faster. Sign up and see the difference.
          </p>
        </div>
        <div className="z-10 self-start">
