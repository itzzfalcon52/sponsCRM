...
function Button({
  ...
  /**
   * Slot.Root and HTMLButtonElement have slightly different
   * ref typings with the current React/Radix type definitions.
   *
   * Using ElementType here preserves the runtime behavior while
   * avoiding the incompatible inferred union between:
   *
   *   Slot.Root
   *   "button"
   */
